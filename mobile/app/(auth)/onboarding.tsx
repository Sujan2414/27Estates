  ...
  const renderItem = ({ item, index }: { item: (typeof PAGES)[0]; index: number }) => (
    <View style={s.page}>
      ...
      <View style={s.cardZone}>
        <Image source={item.illustration} style={s.illustration} resizeMode="contain" />
        {cardForPage(index)}
      </View>
