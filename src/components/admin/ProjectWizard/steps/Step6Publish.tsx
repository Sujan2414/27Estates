    ...
    const handleFinalSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const projectData: Record<string, unknown> = {
                ...
                developer_id: d.developer_id || null,
                developer_name: d.developer_name || null,
                status: d.status,
                category: d.category,
                sub_category: d.sub_category || null,
                total_units: d.total_units ? parseInt(d.total_units) : null,
                min_price: d.min_price || null,
                max_price: d.max_price || null,
                min_price_numeric: d.min_price_numeric ? parseFloat(d.min_price_numeric) : null,
                max_price_numeric: d.max_price_numeric ? parseFloat(d.max_price_numeric) : null,
                price_per_sqft: d.price_per_sqft ? parseFloat(d.price_per_sqft) : null,
                min_area: d.min_area ? parseFloat(d.min_area) : null,
                max_area: d.max_area ? parseFloat(d.max_area) : null,
