...
import { MapPin, Maximize2, Building2, Tag, Heart } from 'lucide-react';
import { proxyUrl } from '@/lib/proxy-url';
import { createClient } from '@/lib/supabase/client';
import styles from './CommercialHomeCard.module.css';

interface CommercialHomeCardProps {
    id: string;
    project_name: string;
    location: string;
    city?: string | null;
...
const CommercialHomeCard: React.FC<CommercialHomeCardProps> = ({
    id,
    project_name,
    location,
    city,
    ...
    const commercialType = bhk_options?.[0] || null;
                ...
                <div className={styles.metaRow}>
                    {min_area && min_area > 0 && (
                        <div className={styles.metaChip}>
                            <Maximize2 size={11} />
                            <span>From {min_area.toLocaleString()} sqft</span>
                        </div>
                    )}
                    {commercialType && (
                        <div className={styles.metaChip}>
...
export default CommercialHomeCard;
