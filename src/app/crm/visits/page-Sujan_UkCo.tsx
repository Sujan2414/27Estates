                                ...
                                <div key={v.id} className={styles.card} style={{ padding: '1rem' }}>
                                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: '1rem' }}>
                                        ...
                                        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.375rem', alignItems: 'flex-end' }}>
                                            ...
                                            {/* Show Visited / No Show buttons for any scheduled visit (not just past).
                                                Agents need to be able to mark a same-day visit done without waiting
                                                for the date to roll over. Cancel only stays available before the
                                                date so a past visit can't be retroactively cancelled — has to be
                                                marked as either Visited or No Show. */}
                                            {v.status === 'scheduled' && (
                                                <div style={{ display: 'flex', flexDirection: 'column', gap: '0.375rem', alignItems: 'flex-end' }}>
                                                    {outcomeVisitId === v.id ? (
                                                        <>
