                        ...
                        <div className={styles.developerCard}>
                            <div className={styles.developerLogo}>
                                {developer?.logo || project.developer_image ? (
                                    <img src={proxyUrl(developer?.logo || project.developer_image || '')} alt={developer?.name || project.developer_name || undefined} style={{ width: '48px', height: '48px', objectFit: 'contain' }} />
                                ) : (
            ...
            <div className={styles.fullWidthContent}>
                ...
                {floorPlans.length > 0 && (
                    <div className={styles.sectionContainer}>
                        ...
                        <div className={styles.floorPlanImage}>
                            <img src={proxyUrl(floorPlans[activeFloorPlan].image)} alt={floorPlans[activeFloorPlan].name} />
                        </div>
                    </div>
                )}
                ...
                {floorPlans.length === 0 && project.master_plan_image && (
                    <div className={styles.sectionContainer}>
                        ...
                        <div className={styles.floorPlanImage}>
                            <img src={proxyUrl(project.master_plan_image)} alt="Master Plan" />
                        </div>
                    </div>
                )}
                ...
                {project.video_url && (
                    <div className={styles.sectionContainer}>
                        ...
                        <VideoPlayer url={project.video_url} title="Project Video Walkthrough" />
                    </div>
                )}
                    ...
                    <div style={{ height: '400px', width: '100%', marginTop: '1rem' }}>
                        <PropertyMap
                            ...
                            projects={[{
                                ...
                                images: proxyUrls(project.images) || [],
                    ...
                    <div className={styles.contactModal} onClick={e => e.stopPropagation()}>
                        ...
                        <div className={styles.modalHeader}>
                            <div className={styles.agentImageWrapper}>
                                {agent?.image ? (
                                    <img src={proxyUrl(agent.image)} alt={agent.name} className={styles.agentImage} />
                                ) : (
                ...
                <div className={styles.modalOverlay} onClick={() => setShowDeveloperModal(false)}>
                    <div className={styles.contactModal} onClick={e => e.stopPropagation()} style={{ textAlign: 'center', maxWidth: '400px' }}>
                        ...
                        <div style={{ marginBottom: '16px', display: 'flex', justifyContent: 'center' }}>
                            {developer?.logo || project.developer_image ? (
                                <img src={proxyUrl(developer?.logo || project.developer_image || '')} alt={developer?.name || project.developer_name || undefined} style={{ width: '80px', height: '80px', objectFit: 'contain', borderRadius: '8px' }} />
                            ) : (
